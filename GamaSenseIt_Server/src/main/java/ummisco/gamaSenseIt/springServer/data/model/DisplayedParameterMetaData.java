...
public class DisplayedParameterMetaData {
	private long id;
	...
	public DisplayedParameterMetaData(long id, String varName, String unit, DataFormat dataFormat,
	...
	public DisplayedParameterMetaData(ParameterMetadata mt)
	{
		this(mt.getId(),
				mt.getVarName(),
				mt.getUnit(),
